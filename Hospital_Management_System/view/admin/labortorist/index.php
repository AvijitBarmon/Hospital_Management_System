            ...
            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                ...
                foreach ($laboratorists as $laboratorist){
                    ...
                    <tr>
                        ...
                        <td class="center">
                            <a href="view/admin/labortorist/view.php?id=<?php echo $laboratorist['unique_id']?>
"class="btn btn-info btn-sm">View</a>
                            <a href="view/admin/labortorist/edit.php?id=<?php echo $laboratorist['unique_id']?>"class="btn btn-warning btn-sm">Edit</a>
        ...
        <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <form action="view/admin/labortorist/temp_delete.php" method="get">
