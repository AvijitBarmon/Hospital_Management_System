    ...
    <div id="page-wrapper" style="min-height: 349px;">
            ...
            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                ...
                foreach ($doctors as $doctor){
                    ...
                    <tr>
                        ...
                        <td class="center">
                            <a href="view/admin/doctor/view.php?id=<?php echo $doctor['unique_id']?>"class="btn btn-info btn-sm">View</a>
                            <a href="view/admin/doctor/edit.php?id=<?php echo $doctor['unique_id']?>"class="btn btn-warning btn-sm">Edit</a>
        ...
        <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <form action="view/admin/doctor/temp_delete.php" method="get">
