    ...
    <div id="page-wrapper" style="min-height: 349px;">
            ...
            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                ...
                foreach ($doctors as $doctor){
                    ...
                    <tr>
                        ...
                        <td class="center">
                            <a href="view/admin/patient/view.php?id=<?php echo $doctor['unique_id']?>"class="btn btn-info btn-sm">View</a>
                            <a href="view/admin/patient/edit.php?id=<?php echo $doctor['unique_id']?>"class="btn btn-warning btn-sm">Edit</a>
                            <a data-toggle="modal" data-target="#myModal"
                               data-id="<?php echo $doctor['unique_id']?>"
        ...
        <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <form action="view/admin/patient/temp_delete.php" method="get">
