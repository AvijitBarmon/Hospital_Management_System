...
<div id="page-wrapper" style="min-height: 349px;">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Update Patient Registration</h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-8 col-md-offset-2">
                            <form role="form" action="view/admin/patient/update.php" method="post" enctype="multipart/form-data">
                                ...
                                <div style="padding-bottom: 25px">
                                    <img width="100" src="view/admin/patient/uploads/<?php echo $doctor['image']?>" alt="">
                                </div>
