                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <dl>
                            ...
                            <dt>Image</dt>
                            <dd><img  class="img-responsive" width="100" src="view/admin/patient/uploads/<?php echo $doctor['image']?>"</dd>

                        </dl>
                        <a href="view/admin/patient/index.php" class="btn btn-danger" class="btn btn-default">Back
                        </a>
                    </div>
