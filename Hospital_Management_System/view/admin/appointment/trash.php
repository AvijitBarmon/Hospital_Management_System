...
$appointments = $appointment->trash();
    ...
    <div class="row">
                ...
                foreach ($appointments as $appointment){
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="view/admin/appointment/restore.php?id=<?php print $appointment['unique_id'];?>" class="btn btn-info btn-sm">Restore</a>
        ...
        <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <form action="view/admin/appointment/delete.php" method="get">
